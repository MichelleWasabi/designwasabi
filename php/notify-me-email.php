<?php
	...
	$email_to = "michelle@designwasabi.com"; // Write your email here to receive the email addresses submitted
    $subject = 'New interests: South Florida Office Space'; // Write the subject you'll see in your inbox
